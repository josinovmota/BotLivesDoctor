...
class Roles(discord.ui.View):
    ...
    async def apply(self, interaction, role):
    ...
    async def button1(self, interaction, button):
        self.apply(interaction, 992133047954702477)
    #Front-end
    ...
    async def button2(self, interaction, button):
        self.apply(interaction, 992133005000843336)
    #Data
    ...
    async def button3(self, interaction, button):
        self.apply(interaction, 992133977882230825)
    #Python
    ...
    async def button4(self, interaction, button):
        self.apply(interaction, 1053439212814348348)
    #C/C++
    ...
    async def button9(self, interaction, button):
        self.apply(interaction, 1054472343839322122)
    #Java/JavaScript
    ...
    async def button5(self, interaction, button):
        self.apply(interaction, 1053439219713982535)
    #TypeScript
    ...
    async def button6(self, interaction, button):
        self.apply(interaction, 1053719075601252503)
    #CSharp
    ...
    async def button7(self, interaction, button):
        self.apply(interaction, 1054428575220113468)
    #Html/Css
    ...
    async def button8(self, interaction, button):
        self.apply(interaction, 1054471923339370566)
